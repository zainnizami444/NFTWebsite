...
{
	$query_Select="Select product.Proid,product.Proimg,product.Proname,product.Description,product.Start_date,product.End_date,product.Userid,product.Bid_Price,product.Fees,status_bid.Status_name from product INNER join status_bid on product.Status_bid=status_bid.Status_id WHERE product.Userid=$Userid";
